...
public class RBMTest {
    ...
    public void testTrainRBM() {
        ...
        RBM rbm = new RBM(6, 2, false, new Random(1));

        ArrayList<RealVector> trainingData = new ArrayList<RealVector>();
        trainingData.add(new ArrayRealVector(new double[]{0, 0, 0, 0, 1, 1}));
        trainingData.add(new ArrayRealVector(new double[]{0, 0, 0, 0, 1, 1}));
        trainingData.add(new ArrayRealVector(new double[]{1, 1, 0, 0, 0, 0}));
        trainingData.add(new ArrayRealVector(new double[]{1, 1, 0, 0, 0, 0}));
        ...
        RealVector hidden = rbm.activateHidden(new ArrayRealVector(new double[]{0, 1, 1, 0, 0, 0}));
        ...
        hidden = rbm.activateHidden(new ArrayRealVector(new double[]{0, 0, 0, 1, 0, 1}));
        ...
        assertEquals(1, visible.getEntry(5), 0.1);
